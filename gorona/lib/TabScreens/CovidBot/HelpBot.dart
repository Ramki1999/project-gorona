...
import 'package:gorona/TabScreens/CovidBot/MapSearch.dart';
...
class _HelpBotState extends State<HelpBot> {
  ...
  WatsonAssistantV2Credential credential = WatsonAssistantV2Credential(
    ...
    assistantID: WatsonKey.WATSON_ASSISTANT_COVIDBOT_ID, //WATSON ASSISTANT ID
  ...
  void response(query) async {
    ...
    setState(() {
      ...
      if (watsonAssistantResponse.resultText.substring(0, 23) ==
          "COVID-19 RELIEF CENTERS") {
        setState(() {
          mapMarkers = "Shelter";
          _mapState = true;
          print(watsonAssistantResponse.resultText.substring(29, 38));
        });
      } else if (watsonAssistantResponse.resultText.substring(0, 18) ==
          "QUARANTINE CENTERS") {
        setState(() {
          mapMarkers = "Quarantine";
          _mapState = true;
          print(watsonAssistantResponse.resultText.substring(0, 18));
        });
      }
    });
