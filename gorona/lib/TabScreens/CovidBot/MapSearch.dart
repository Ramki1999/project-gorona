    ...
    return Scaffold(
      ...
      body: GoogleMap(
        ...
        onMapCreated: (controller) {
          print(widget.markerOpt);
          if (widget.markerOpt == "Quarantine") {
            setState(() => markers = new Set.from(
                [initaialmarker1, Amarker1, Amarker2, Amarker3, Amarker4]));
          }else if (widget.markerOpt == "Shelter") {
            setState(() => markers = new Set.from(
                [initaialmarker1, Smarker1, Smarker2, Smarker3, Smarker4, Fmarker1, Fmarker2, Fmarker3, Fmarker4]));
          }
        },
        markers: markers,
      ),
...
Marker Amarker1 = Marker(
    ...
    infoWindow: InfoWindow(title: "Quarantine Center 1"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueViolet));
Marker Amarker2 = Marker(
    markerId: MarkerId("marker2"),
    position: LatLng(12.913652, 80.172234),
    infoWindow: InfoWindow(title: "VIT Chennai - Quarantine Center B"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueViolet),
    draggable: true);
...
Marker Amarker3 = Marker(
    ...
    infoWindow: InfoWindow(title: "College of  Guindy - Quarantine center A",snippet: "click the navigation to know more"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueViolet),
    draggable: true);
...
Marker Amarker4 = Marker(
    ...
    infoWindow: InfoWindow(title: "Apollo Quarantine Center"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueViolet),
    draggable: true);
...
Marker Smarker1 = Marker(
    ...
    infoWindow: InfoWindow(title: "Relief Center -1 ",snippet: "Public Night Shelter,Elderly"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed));
Marker Smarker2 = Marker(
    markerId: MarkerId("Public Night Shelter,Transgender"),
    position: LatLng(13.074279, 80.242828),
    infoWindow: InfoWindow(title: "Covid Relief center -A"),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
    draggable: true);
